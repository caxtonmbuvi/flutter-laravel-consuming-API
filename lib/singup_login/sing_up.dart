        ...
        SingleChildScrollView(
          child: Container(
            ...
            children: [
              ...
              SizedBox(height: height*.05,),
              TextInput(textString:"Password", textController:passController, obscureText: false,),
              SizedBox(height: height*.05,),
              TextInput(textString:"Password", textController:repassController, obscureText: false,),
              SizedBox(height: height*.05,),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
