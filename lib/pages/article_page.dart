...
/*
  ...
  _initData() async {
     CallApi().getPublicData("recommendedarticles").then((response) {
      setState(() {
          ...
          Expanded(
            ...
            child: Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                    // debugPrint(allacticles[i].img.toString());
                          ...
                          child: Column(
                            ...
                            children: [
                              Card(
                                ...
                                child: Image.network(
                                  "http://10.0.2.2:8000/uploads/" + allarticles[i].img.toString(),
                                  fit: BoxFit.contain,
                                ),
                                shape: RoundedRectangleBorder(
                              ...
                              TextWidget(text: allarticles[i].author==null?"Author: Dylan": allarticles[i].author)
                            ],
                          ),
                        ),
                      );
